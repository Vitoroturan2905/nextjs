    ...
    return(
        <div className="fotinha" >
           <div className="foto_nome">
            ...
            <h4 className="nome_fotinha"> Thainara Costa </h4> 
            <span className="icone">{props.icone}</span>
            </div>
        
            <div className="img_timeline">
            <img className='img_timeline2' src={img2} />
            </div>
            ...
            <div className='detalhes_timeline'>
             <div className='detalhes_conteudo'>
                ...
                <div className='as'>
                <a className='a_tam'>Curtido por <b>vitorls</b> e mais 90 pessoas</a>
                <a className='a1'> <b>thainara costa </b> hello!  </a>
                <a className='a2'> ver todos os 10 comentarios  </a>
                <a className='a1'> <b>vitorls </b> {<BsSuitHeart />} </a>
                <a className='a1'> <b>mCris</b> Lindo!!  </a>
                <a className='a3'> Há 10 horas </a>
